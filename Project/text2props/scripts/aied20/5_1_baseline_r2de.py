from text2props.text2props.model.literature_architectures import R2DEText2PropsModel
from text2props.text2props.constants import DATA_PATH
import os
import pandas as pd
import pickle
...
text2props_model = R2DEText2PropsModel(known_latent_traits=dict_latent_traits)
