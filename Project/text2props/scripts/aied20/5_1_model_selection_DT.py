...
print("[INFO] Start of 5_1_model_selection_DT.py")
...
for min_df in np.arange(0.00, 0.11, 0.02):
    for max_df in np.arange(0.90, 1.01, 0.02):
        ...
        dict_params = {
            DIFFICULTY: [{'regressor__max_features': randint(1, 10), 'regressor__max_depth': randint(2, 50)}],
            DISCRIMINATION: [{'regressor__max_features': randint(1, 10), 'regressor__max_depth': randint(2, 50)}],
        }
