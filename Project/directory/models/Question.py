...
class Question(models.Model):
	...
	question_difficulty = models.DecimalField(max_digits=6, decimal_places=3, null=True, blank=True, default=None)
	question_discrimination = models.DecimalField(max_digits=6, decimal_places=4, null=True, blank=True, default=None)
	question_facility = models.DecimalField(max_digits=6, decimal_places=4, null=True,blank=True, default=None)
